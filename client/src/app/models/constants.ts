...
export const Levels = [
  ...
  },
  {
    level_id: 5,
    level: 4,
    education_level: 'Master of Business'
  },
  {
    level_id: 6,
    level: 5,
    education_level: 'Master of Arts'
  },
  {
    level_id: 7,
    level: 6,
  ...
  },
  {
    level_id: 8,
    level: 7,
    education_level: 'Master of Engineering'
  },
  {
    level_id: 9,
    level: 8,
...
export const SkillLevelDescription = {
  ...
  6: { 'title': 'Expert: ', 'description': 'extensive training, possible research experience, and substantial work experience. This level is usually reserved for people with at least 5 years of academic or industry experience or for people with a graduate level education.' }
};
